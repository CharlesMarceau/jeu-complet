...
var mainState = {
	...
	// pour ce projet, on utilise 3 fonctions

	preload: function() {
		// cette fonction va être exécutée au début
		// c'est où on load les "assets" du jeu
	...
	create: function() {
		...
		// couleur du background de la dimension du jeu -> le 'stage' le défini
		game.stage.backgroundColor = "#3498db"; // bleu
...
// on initialise Phaser
var game = new Phaser.Game ( 500, 340, Phaser.AUTO, 'gameDiv');



// et finalement on appel Phaser pour ajouter et démarrer notre 'main' scène (state)
